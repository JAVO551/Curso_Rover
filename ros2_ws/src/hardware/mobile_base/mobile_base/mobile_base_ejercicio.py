...
#
#El siguieunte código implementa un nodo de ROS2 que permite controlar los servos y la velocidad de las llantas del rover.
#El código tambien incluye las funciones necesarias para recuperar información util para la odometría.
...
#Revisar la linea 329 del código (función update_odometry) y seguir sus instrucciones para completar el código.
...
class MobileBaseNode(Node): 
    ...
    def update_odometry(self):
        ...
        #Lectura de la distancia recorrida segun los encoders de las ruedas.
        ...
        #Complete las ecuaciones para el álculo de la distancia recorrida y el ángulo avanzado del robot
        #d_theta = __________
        #d_s = _________


        #Seleccione la tercia de ecuaciones correcta para traducir el avance del robot a la posición y orientación actual del robot
        
        #a)
        # self.x += d_theta * math.sin(self.theta)
        # self.y += d_theta * math.cos(self.theta)
        # self.theta += d_s
